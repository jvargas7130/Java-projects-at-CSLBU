	...
	public static void menu() {
		...
		while (!done) {//beginner
			...
			if (choose == 1) {
				...
				pattern = playGame(player, pattern, computer);
				int win = winner(player, c, pattern, computer);
				...
				//player chooses 
				int player = CheckInput.checkInt(1, 3);
				pattern = playGame(player, pattern, computer);//plays game and returens pattern
				int win = winner(player, c, pattern, computer);//chooses winner and returns value
